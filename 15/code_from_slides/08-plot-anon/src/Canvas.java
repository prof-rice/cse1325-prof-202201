...
public class Canvas extends JPanel {
    ...
    public Canvas() {
        ...
        */
        ...
        // Plot two functions using anonymous classes
        Plot f1 = new Plot(new FunctionToPlot() {
            @Override
            public double fn(double x) {
                return Math.cos(x);
            }}, -370, 0,   0, 3.14*6,   160,   40, 25);
        shapes.add(f1);

        Plot f2 = new Plot(new FunctionToPlot() {
            @Override
            public double fn(double x) {
                return Math.cos(x) + x/3.14;
            }}, -370, 0,   0, 3.14*6,   160,   40, 25);
        shapes.add(f2);
    }
