...
public class Canvas extends JPanel {
    ...
    public Canvas() {
        ...
        */
        ...
        // Plot random function (NO parameters)
        Plot f1 = new Plot(x -> Math.random(),   -370, 0,   0, 3.14*6,   160,   40, 100);
        shapes.add(f1);

        // Plot power function (TWO parameters)
        Plot f2 = new Plot(x -> Math.pow(1.2, x),   -370, -280,   0, 3.14*6,   160,   40, 25);
        shapes.add(f2);
    }
