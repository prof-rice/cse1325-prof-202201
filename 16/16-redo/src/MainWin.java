...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
        ...
        redoButton.setToolTipText("Restore the most recently undone shape");
        ...
        freehandButton.setActionCommand("SelectContiguous");
        freehandButton.setToolTipText("Draw connected lines (click-click-click…)");
