...
public class MainWin extends JFrame {
    ...
    public static final String FILE_VERSION = "0.3";
    ...
    public MainWin(String title) {
        ...
        textButton.setActionCommand("Select text");
    ...
    protected void onQuitClick() {   // Exit the program
        if(okToExit()) System.exit(0); //System.exit(0);
    }
    ...
    protected void onAboutClick() {                 // Display About dialog
        ...
        JLabel title = new JLabel("<html>"
          + "<p><font size=+4>CSE1325 Paint</font></p>"
          + "</html>");
        about.add(title);

        JLabel artists = new JLabel("<html>"
          + "<p>Version " + VERSION + "</p>"
          + "<p>Copyright 2017-2021 by George F. Rice</p>"
